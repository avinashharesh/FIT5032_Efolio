...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <button :class="{active:isActive}" @click="showMessage = !showMessage">Toggle Message</button>
    ...
    <section class="lab-section">
      ...
      <ul>
        <li
          ...
          :key="author.id"
          :style="{ color: author.name === 'George Orwell' ? textColor : 'black', fontSize: fontSize + 'px' }"
        >
          {{ author.name }}
        </li>
      </ul>
